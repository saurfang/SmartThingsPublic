...
metadata {
	definition(name: "ORVIBO/Yooksmart/Yoolax Zigbee Window Shades", namespace: "avianwaves", author: "AvianWaves", ocfDeviceType: "oic.d.blind", mnmn: "SmartThings", vid: "generic-shade-3") {
		capability "Actuator"
		capability "Battery"
